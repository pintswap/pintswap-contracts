...
export interface GlobalDeployerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activatePrank"
      | "autoBroadcasting"
...
export interface GlobalDeployer extends BaseContract {
  connect(runner?: ContractRunner | null): GlobalDeployer;
  waitForDeployment(): Promise<this>;

  interface: GlobalDeployerInterface;
  ...
  autoBroadcasting: TypedContractMethod<[], [boolean], "view">;
