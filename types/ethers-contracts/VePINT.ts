...
export interface VePINTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface VePINT extends BaseContract {
  connect(runner?: ContractRunner | null): VePINT;
  waitForDeployment(): Promise<this>;

  interface: VePINTInterface;
