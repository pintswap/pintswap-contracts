...
export interface Vm extends BaseContract {
  ...
  ): TypedContractMethod<[json: string, key: string], [string], "nonpayable">;
  getFunction(
    nameOrSignature: "parseJsonAddressArray"
  ): TypedContractMethod<[json: string, key: string], [string[]], "nonpayable">;
  getFunction(
    nameOrSignature: "parseJsonBool"
  ): TypedContractMethod<[json: string, key: string], [boolean], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[json: string, key: string], [bigint], "nonpayable">;
  getFunction(
