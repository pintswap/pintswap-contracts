...
export interface DeploymentsInterface extends Interface {
...
export interface Deployments extends BaseContract {
  connect(runner?: ContractRunner | null): Deployments;
  waitForDeployment(): Promise<this>;

  interface: DeploymentsInterface;
